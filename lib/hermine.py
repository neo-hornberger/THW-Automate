...
#
# License: ./hermine.LICENSE
#
# Original source code commit (https://codeberg.org/aeberhardt/stashcat-api-client/):
# 84bf2879828bc8d3e1a00a8438966039788652ce
#
# Modified by: Neo Hornberger
#
...
class StashCatClient:
    ...
    def send_msg(self, target, message, *, files=None, location=None, is_styled=False):
        files = files or []
